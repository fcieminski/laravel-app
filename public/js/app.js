...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("h2", [
      _vm._v(
        "Amount of Cruds: " +
          _vm._s(_vm.cruds.length > 0 ? _vm.cruds.length : "")
      )
    ]),
    _vm._v(" "),
    _c(
      ...
      _vm._l(_vm.cruds, function(crud) {
        return _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "container__crud-buttons" }, [
              _c(
                "button",
                {
              ...
              _c(
                ...
                {
                  staticClass:
                    "container__crud-button container__crud-button--color",
                  on: {
                    click: function($event) {
                      return _vm.update(crud.id, crud.color)
                    }
                  }
                },
                [_vm._v("Change color")]
